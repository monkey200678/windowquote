...
@section('title', 'Movie Management - Edit Profile')
@section('page-style')
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body card-dashboard">
                                <form class="form-horizontal" action="{{ route('bio.update',$data->id) }}" novalidate method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image: url(@if($data->photo) {{ url('/') }}{{ $data->photo }}  @else {{ asset('app-assets/images/portrait/small/avatar-s-12.jpg') }});@endif">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="birthday" class="form-control"  value="{{ $data->date_of_birth }}" maxlength="10"
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="d-inline-block mr-2">
                                                            <fieldset>
                                                                <div class="vs-radio-con">
                                                                    <input type="radio" name="gender" @if($data->gender == 0) checked @endif value="0">
                                                                    <span class="vs-radio">
                                                        ...
                                                        <li class="d-inline-block mr-2">
                                                            <fieldset>
                                                                <div class="vs-radio-con">
                                                                    <input type="radio" name="gender" @if($data->gender == 1) checked @endif value="1">
                                                                    <span class="vs-radio">
                                                                        <span class="vs-radio--border"></span>
                                                                        <span class="vs-radio--circle"></span>
                                                                    </span>
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="hometown" class="form-control"  value="{{ $data->hometown }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="ethnicity" class="form-control"  value="{{ $data->ethnicity }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="nationality" class="form-control"  value="{{ $data->nationality }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="hair_color" class="form-control"  value="{{ $data->hair_color }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="height" class="form-control"  value="{{ $data->height }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="weight" class="form-control"  value="{{ $data->weight }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="misc" class="form-control"  value="{{ $data->misc }}"
                                        ...
                                        <div class="col-md-4 col-12">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" id="activated_years" class="form-control"  value="{{ $data->years_active }}"
