...
$(document).ready(function () {
    ...
    var customBadgeHTML = function (params) {
        ...
        if (params.value == "open") {
            color = "success";
            return "<a href='ticket-view/"+params.data.id+"'><div class='badge badge-pill badge-light-" + color + "' >" + params.value + "</div></a>"
    ...
    var customAvatarHTML = function (params) {
        return "<a href='ticket-view/"+params.data.id+"'><span class='avatar'><img src='" + params.data.picture + "' height='32' width='32'></span>"+params.data.name+"</a>"
    };
    ...
    var customDate = function (params) {
        ...
        if(params.value == null){
            ...
            val = moment(params.value, 'YYYY-MM-DD HH:mm:ss').format('YYYY-MM-DD'); //dddd,DD MMMM
        }
        return val;
    };
    // ag-grid
